...
//        	    String mensaje = "DNI "+ du + " YA CARGADO.";
			...
			if (!validos2) {
				...
				while (oppartido < 1 || oppartido > epartido.values().length) {
					System.out.println(
							"INGESE PARTIDO VALIDO (Opción válida entre 1 y " + epartido.values().length + "):");
					for (int i = 0; i < epartido.values().length; i++) {
						System.out.println(i + 1 + " - " + epartido.values()[i].name());
					}
				...
				CCandidato.cargarcandidato(du2, nombre2, apellido2, genero2, edad2, domicilio2, partido, lema,
						vecesvotado);
		...
		case 99999:
			// CARGAS PARA PRUEBA
			CCandidato.cargarcandidato(98765432, "Pedro", "Gómez", egenero.masculino, 40, "Calle 789",
					epartido.FRENTE_DE_TODOS, "Un nuevo camino", 0);
			CCandidato.cargarcandidato(10987654, "Ana", "Fernández", egenero.femenino, 35, "Calle 1011",
					epartido.FRENTE_DE_TODOS, "Por la unidad", 0);
			CCandidato.cargarcandidato(12131415, "Sofía", "López", egenero.femenino, 22, "Calle 1415", epartido.PODEMOS,
					"Hacia un futuro mejor", 0);
			CCandidato.cargarcandidato(13141516, "Diego", "Rodríguez", egenero.masculino, 50, "Calle 1617",
					epartido.LIBRES_DEL_SUR, "Por la justicia social", 0);
			CCandidato.cargarcandidato(14151617, "Camila", "Sánchez", egenero.femenino, 45, "Calle 1819",
					epartido.JUNTOS_POR_EL_CAMBIO, "Un cambio con progreso", 0);
			CCandidato.cargarcandidato(16171819, "Laura", "Pérez", egenero.femenino, 25, "Calle 2223",
					epartido.REVOLUCIÓN_CIVIL, "Por la igualdad", 0);
